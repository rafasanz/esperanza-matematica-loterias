...
export const toggleBall = createAction<{ type: IBetBallType; value: number }>(
  'TOGGLE_BALL',
);

export const setPrimitivaDraw =
  createAction<IBetsState['primitiva']['draw']>('SET_PRIMITIVA_DRAW');

export const setEuromillonesDraw = createAction<
  IBetsState['euromillones']['draw']
>('SET_EUROMILLONES_DRAW');
